# `TMatrix_jll.jl` (v0.1.0+0)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl). The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/68c8d0d70b881efef1a6bd96030a110650a60602/T/TMatrix/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.  If you have any issue, please report it to the Yggdrasil [bug tracker](https://github.com/JuliaPackaging/Yggdrasil/issues).

For more details about JLL packages and how to use them, see `BinaryBuilder.jl` [documentation](https://juliapackaging.github.io/BinaryBuilder.jl/dev/jll/).

## Sources

The tarballs for `TMatrix_jll.jl` have been built from these sources:

* git repository: https://github.com/JuliaRemoteSensing/TMatrix-fortran.git (revision: `bf0d1bf15ff382b562427492895f8f3d0fb6b177`)

## Platforms

`TMatrix_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `TMatrix_jll.jl`:
...
* `LibraryProduct`: `tmatrix_fixed_orientation`
* `LibraryProduct`: `tmatrix_random_orientation`
